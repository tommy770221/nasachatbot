...
privileged aspect AttachmentController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> AttachmentController.showJson(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<String> AttachmentController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
        ...
        try {
            ...
            headers.add("Location",uriBuilder.path(a.value()[0]+"/"+attachment.getId().toString()).build().toUriString());
    ...
    public ResponseEntity<String> AttachmentController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Attachment attachment = Attachment.fromJsonToAttachment(json);
    ...
    public ResponseEntity<String> AttachmentController.deleteFromJson(@PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Attachment attachment = Attachment.findAttachment(id);
